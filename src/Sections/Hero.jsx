  ...
  return (
    <section
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-dm:leading-[82] font-bold">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:mi-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img 
          src={bigShoeImg}
          alt="shoe collection"
          width={610}
